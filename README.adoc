...
The above command returns 5, because there was a total of 5 requests made to the `system` service that included the initial request, 3 MicroProfile retry requests, and the succesful request that you made before you paused the `system` service.
